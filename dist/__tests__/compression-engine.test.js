...
const compression_engine_1 = require("../rtk/compression-engine");
describe('CompressionEngine', () => {
    let engine;
    const longInput = 'a'.repeat(1000);
    beforeEach(() => {
        engine = new compression_engine_1.CompressionEngine();
    });
...
//# sourceMappingURL=compression-engine.test.js.map